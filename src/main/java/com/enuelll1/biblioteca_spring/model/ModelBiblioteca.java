...
@Setter
@Entity
@Table(name = "livros_bd", indexes = {
        @Index(name = "idx_titulo", columnList = "tituloLivro"),
...
public class ModelBiblioteca {
    ...
    // Definindo a coluna disponivel da tabela "livros_db"
    // Definindo que ela pode ter um valor booleano, e não pode ser NULO
